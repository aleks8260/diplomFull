	...
	<div class="row">
		<div class="offset-md-1 col-md-10">
			...
			<form class="edit-user-profile-form" enctype="multipart/form-data" action="<?=HOST?>profile-edit" method="POST">
				...
				<div class="row edit-user-profile-form__row">
					<div class="col-md-4">
						<label class="label">Фамилия<input class="input-text" type="text" placeholder="Введите фамилию" name="secondname" value="<?=@$currentUser->secondname?>"/></label>
					</div>
				</div>
				<div class="row edit-user-profile-form__row">
					<div class="col-md-4">
				...
				<div class="row edit-user-profile-form__row">
					<div class="col-md-9">
						...
						<div class="load-file-fieldset">
							<input class="inputfile" id="avatar" type="file" name="avatar" data-multiple-caption="{count} файлов выбрано" multiple="" /><label for="avatar">Выбрать файл</label><span>Файл не выбран</span>
						</div>
					</div>
				</div>
				<div class="row edit-user-profile-form__row">
					<div class="col-md-4">
						<label class="label">Страна<input class="input-text" type="text" placeholder="Введите страну" name="country" value="<?=@$currentUser->country?>"/></label>
					</div>
				</div>
				<div class="row edit-user-profile-form__row">
					<div class="col-md-4">
						<label class="label">Город<input class="input-text" type="text" placeholder="Введите город" name="city" value="<?=@$currentUser->city?>"/></label>
					</div>
				</div>
				<div class="row edit-user-profile-form__row">
